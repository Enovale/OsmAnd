...
public class OPRWebviewActivity extends OsmandActionBarActivity {
	...
	private static final String ***REMOVED***Url = BuildConfig.OPR_BASE_URL + "profile";
	...
	private static final String finishUrl = ***REMOVED***Url;
	...
	private static String returnCookieByKey(String key) {
		...
		CookieManager ***REMOVED***Manager = CookieManager.getInstance();
		String ***REMOVED***s = ***REMOVED***Manager.getCookie(***REMOVED***Url);
		if (***REMOVED***s == null || ***REMOVED***s.isEmpty()) {
			return "";
		}
		String[] temp = ***REMOVED***s.split(";");
		for (String ar1 : temp) {
			if (ar1.contains(key)) {
