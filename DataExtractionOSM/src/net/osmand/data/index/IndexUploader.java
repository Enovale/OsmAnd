...
public class IndexUploader {
	...
	@Deprecated
	public void uploadToGoogleCode(File f, String summary, String user, String password, String token, String pagegen, String ***REMOVED***HSID,
			String ***REMOVED***SID) throws IOException {
		...
		try {
			DownloaderIndexFromGoogleCode.deleteFileFromGoogleDownloads(f.getName(), token, pagegen, ***REMOVED***HSID, ***REMOVED***SID);
			if (f.getName().endsWith("obf.zip") && f.length() / MB < 5) {
				...
				DownloaderIndexFromGoogleCode.deleteFileFromGoogleDownloads(f.getName().substring(0, f.getName().length() - 4), token,
						pagegen, ***REMOVED***HSID, ***REMOVED***SID);
				...
				DownloaderIndexFromGoogleCode.deleteFileFromGoogleDownloads(f.getName().substring(0, f.getName().length() - 3) + "odb",
						token, pagegen, ***REMOVED***HSID, ***REMOVED***SID);
	...
	public boolean uploadFileToServer(File original, String summary, String user, String password, boolean uploadToOsmandGooglecode,
			String token, String pagegen, String ***REMOVED***HSID, String ***REMOVED***SID) throws IOException {
			...
			if (uploadToOsmandGooglecode) {
				...
				try {
					...
					for (File fs : splittedFiles) {
						uploadToGoogleCode(fs, summary, user, password, token, pagegen, ***REMOVED***HSID, ***REMOVED***SID);
					}
