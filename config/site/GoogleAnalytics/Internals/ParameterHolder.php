...
class ParameterHolder {	
	...
	/**
	 * Contains all ***REMOVED*** values, see below
	 * @var string
	 */
	public $utmcc;
    ...
    /**
	 * Visitor tracking ***REMOVED*** parameter.
	 * 
	 * This ***REMOVED*** is typically written to the browser upon the first visit to your site from that web browser.
	 * If the ***REMOVED*** has been deleted by the browser operator, and the browser subsequently visits your site,
	 * a new __utma ***REMOVED*** is written with a different unique ID.
	 * 
	 * This ***REMOVED*** is used to determine unique visitors to your site and it is updated with each page view.
	 * Additionally, this ***REMOVED*** is provided with a unique ID that Google Analytics uses to ensure both the
	 * validity and accessibility of the ***REMOVED*** as an extra security measure.
	 * 
	 * Expiration:
    ...
    /**
	 * Session timeout ***REMOVED*** parameter.
	 * Will never be sent with requests, but stays here for documentation completeness.
	 * 
	 * This ***REMOVED*** is used to establish and continue a user session with your site.
	 * When a user views a page on your site, the Google Analytics code attempts to update this ***REMOVED***.
	 * If it does not find the ***REMOVED***, a new one is written and a new session is established.
	 * 
	 * Each time a user visits a different page on your site, this ***REMOVED*** is updated to expire in 30 minutes,
	 * thus continuing a single session for as long as user activity continues within 30-minute intervals.
	 * 
	 * This ***REMOVED*** expires when a user pauses on a page on your site for longer than 30 minutes.
    ...
    /**
	 * Session tracking ***REMOVED*** parameter.
	 * Will never be sent with requests, but stays here for documentation completeness.
	 * 
	 * This ***REMOVED*** operates in conjunction with the __utmb ***REMOVED*** to determine whether or not
	 * to establish a new session for the user.
	 * In particular, this ***REMOVED*** is not provided with an expiration date,
	 ...
	 * the absence of the __utmc ***REMOVED*** indicates that a new session needs to be established,
	 * despite the fact that the __utmb ***REMOVED*** has not yet expired.
	 * 
	 * Expiration:
	 * Not set.
	 * 
    ...
    /**
	 * Campaign tracking ***REMOVED*** parameter.
	 * 
	 * This ***REMOVED*** stores the type of referral used by the visitor to reach your site,
	 ...
	 * The ***REMOVED*** is updated with each page view to your site.
	 * 
	 * Expiration:
    ...
    /**
     * Website Optimizer ***REMOVED*** parameter.
	 * 
	 * This ***REMOVED*** is used by Website Optimizer and only set when Website Optimizer is used in combination
	...
	// TODO: Implementation needed?
	/**
	 * Deprecated custom variables ***REMOVED*** parameter.
	 * 
	 * This ***REMOVED*** parameter is no longer relevant as of migration from setVar() to
	 * setCustomVar() and hence not supported by this library, but will stay here for
	 * documentation completeness.
	 * 
	 * The __utmv ***REMOVED*** passes the information provided via the setVar() method,
